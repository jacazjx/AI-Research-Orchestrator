    ...
    "pilot": [
        {
            ...
            "required_artifacts": ["docs/pilot/problem-validation-report.md"],
        },
        {
            "name": "problem_analysis",
            "primary_skill": "analyze-problem",
            "reviewer_skill": "audit-analysis",
            "required_artifacts": ["docs/pilot/problem-analysis.md"],
        },
        {
            "name": "pilot_design",
            "primary_skill": "design-pilot",
            "reviewer_skill": "audit-design",
            "required_artifacts": ["docs/pilot/pilot-design.md"],
        },
        {
            "name": "pilot_execution",
            "primary_skill": "run-pilot",
            "reviewer_skill": "audit-pilot",
            "required_artifacts": ["docs/pilot/pilot-validation-report.md"],
        },
    ],
    "experiments": [
        {
            ...
            "required_artifacts": ["docs/experiments/experiment-spec.md"],
        },
        {
            "name": "experiment_execution",
            "primary_skill": "run-experiment",
            "reviewer_skill": "monitor-experiment",
            "required_artifacts": ["docs/experiments/run-registry.md"],
        },
        {
            "name": "results_analysis",
            "primary_skill": "analyze-results",
            "reviewer_skill": "audit-results",
            "required_artifacts": ["docs/experiments/evidence-package-index.md"],
        },
    ],
    "paper": [
        {
    ...
    "reflection": [
        {
            ...
            "required_artifacts": ["docs/reflection/lessons-learned.md"],
        },
        {
            "name": "overlay_proposal",
            "primary_skill": "propose-overlay",
            "reviewer_skill": "audit-overlay",
            "required_artifacts": ["docs/reflection/runtime-improvement-report.md"],
        },
    ],
}
